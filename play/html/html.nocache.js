...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "html" because\n';
 ...
 * "/html.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['html'].superdevmode = true;
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + html + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:html';
  var devModeSessionKey = '__gwtDevModeSession:html';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':50337';
  var nocacheUrl = serverUrl + '/html/html.nocache.js';
  ...
  $wnd.__gwt_activeModules['html'].canRedirect = true;
  $wnd.__gwt_activeModules['html'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/html?user.agent=' + ua + '&_callback=' + callback;
